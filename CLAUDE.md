...
The name **Golden Palace** refers to the mind palace memory technique applied to God's Word — gold being the material of the Holy of Holies, the inner sanctuary where God's presence dwelt. This repository is that inner sanctuary in digital form.
...
├── major-system/       # Hebrew Major System — digits 0-9 mapped to Hebrew letters
...
1. **Hebrew Major System** — digits 0-9 mapped to Hebrew alphabet letters (not English phonetics)
...
## Documentation Format — PAO Entries
...
## Documentation Format — Hebrew Letters
