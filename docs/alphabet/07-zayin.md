...
3. **The SWORD OF THE SPIRIT is a ZAYIN.** Ephesians 6:17 says, _"Take the helmet of salvation and the sword of the Spirit, which is the word of God."_ The Greek word for "word" here is _rhema_—a spoken word. The Hebrew concept is _dabar_ (דבר), which begins with dalet (door) but contains the power to cut. The zayin-sword is the word that cuts through lies and liberates truth.
