...
Jesus quoted Scripture from memory in Matthew 4 — three times He said, _"It is written"_ with no scroll in His hand. The Word inside you is a weapon. Memory techniques are just tools to help you build that internal arsenal.

## Learning Path (Best Order)

Learn in this order so each step builds on the previous:

1. **Hebrew Alphabet** — Pictographs and values. Everything else (Major System, gematria, PAO ideas) depends on this. Start at [Alphabet](/alphabet/).
2. **Mind Palace** — Set one palace (e.g. home), define your route and stations. Low cognitive load; you can store simple images before PAO. [Learn more →](/techniques/mind-palace)
3. **Hebrew Major System** — Digits 0–9 → Hebrew letters → images. Lets you encode verse references (e.g. John 3:16 → 03 + 16). [Learn more →](/techniques/major-system)
4. **PAO** — Build 00–99 with Biblical figures first (Moses with staff, David with sling) so your palace stays Golden. [Learn more →](/techniques/pao)
5. **Gematria for memory** — Add numerical hooks once verses are in the palace. Use as a spice, not the main dish. [Learn more →](/techniques/gematria)
6. **Spaced repetition** — Use from day one. Review morning, walk, evening, lie down (Deuteronomy 6:7). [Learn more →](/techniques/spaced-repetition)
...
[Learn more →](/techniques/mind-palace)
...
[Learn more →](/techniques/major-system)
...
[Learn more →](/techniques/spaced-repetition)
...
[Learn more →](/techniques/gematria)
...
- [Mattias Ribbing's TEDx Talk](https://www.youtube.com/watch?v=8_vPAc2eBmY)
- [Ancient Techniques for Enhancing Memory](https://www.artofmemory.com/blog/how-to-use-a-memory-palace/) — Art of Memory

**PAO System:**

- [How to Build a PAO System](https://www.artofmemory.com/blog/how-to-build-a-pao-system/) — Art of Memory
- [Nelson Dellis' PAO Tutorial](https://www.youtube.com/watch?v=P8zu-Nk0nIg) — 4x USA Memory Champion

**Spaced Repetition:**

- [Gabriel Wyner's Fluent Forever Method](https://fluent-forever.com/) — Applies spaced repetition to language learning
- [Anki Spaced Repetition System](https://apps.ankiweb.net/) — Free SRS software
