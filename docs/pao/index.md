...
1. **Build a library** — Assign one Person–Action–Object scene to each two-digit number from 00 to 99. (This site gives you a full set: 100 pegs.)
...
If you want the full story — why biblical first, how it fits with the Hebrew Major System and mind palace — see [PAO System](/techniques/pao) in Techniques.
